...
SCENE_TEMPLATES = {
    "family_return": {
        ...
        "related_events": [
            ...
            {"event_type": "turn_on_hallway_light", "predicate": "on", "object_id": "light_hallway",
             "description": "玄关光线较暗时打开玄关灯"},
            {"event_type": "turn_on_living_room_ac", "predicate": "on", "object_id": "ac_living_room",
             "description": "客厅温度不舒适时打开客厅空调"},
            {"event_type": "turn_on_living_room_tv", "predicate": "on", "object_id": "tv_living_room",
            ...
            {"event_type": "start_fresh_air", "predicate": "on", "object_id": "fresh_air_system",
             "description": "空气质量较差时启动新风系统"},
            {"event_type": "speaker_welcome", "predicate": "speaking", "object_id": "smart_speaker",
