...
%s 正在家中接待来访的客人 %s。今天是 %s。请扮演 %s 的角色，写下你对客人 %s 要说的下一句话。如果开始对话，可以从开门打招呼、邀请客人进门、询问来访目的、提供饮品、介绍家里情况开始。不要重复之前已分享的信息。让对话围绕客人来访的活动，例如热情问候、询问旅途情况、提供茶水招待、了解来访意图、介绍家人、安排座位等。包括时间参考，如"今天"、"这会儿"等。回复不超过20个字。
...
- 如果开始对话，可以从开门打招呼、邀请客人进门、询问来访目的、提供饮品、介绍家里情况开始。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天"、"这会儿"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
%s 正在家中接待来访的客人 %s。今天是 %s。以下是 %s 最近发生的事件。
事件：%s

请扮演 %s 的角色，与客人 %s 就这些事件进行对话，围绕客人来访的活动。%s
"""


AGENT_CONV_PROMPT = """%s

%s 上次接待来访的客人 %s 是在 %s。%s

今天是 %s。请扮演 %s 的角色，写下你对客人 %s 要说的下一句话。如果开始对话，可以从开门打招呼、邀请客人进门、询问来访目的、提供饮品、介绍家里情况开始。不要重复已分享的信息。让对话围绕客人来访的活动，例如热情问候、询问旅途情况、提供茶水招待、了解来访意图、介绍家人、安排座位等。包括时间参考，如"今天"、"这会儿"等。回复不超过20个字。
...
- 如果开始对话，可以从开门打招呼、邀请客人进门、询问来访目的、提供饮品、介绍家里情况开始。
- 不要重复之前对话中已分享的信息。
- 让对话围绕客人来访的活动，例如热情问候、询问旅途情况、提供茶水招待、了解来访意图、介绍家人、安排座位等。
- 包括时间参考，如"今天"、"这会儿"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
今天是 %s。你是 %s。以下是你最近发生的事件：
%s

在对话中使用这些事件。%s 请根据你的PERSONALITY写下你在与客人 %s 的对话中要说的下一句话：
"""
...
使用给定的PERSONALITY写下对话中你要说的下一句话。
- 回复不超过20个字。
- 让对话围绕客人来访的活动，例如热情问候、询问旅途情况、提供茶水招待、了解来访意图、介绍家人、安排座位等。详细讨论重要的事件。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天"、"这会儿"等。
...
%s 请写下你在与客人 %s 的对话中要说的下一句深思熟虑的话。在对话中只讨论给定的事件及其对客人来访活动的影响。如果事件有负面影响，请表达担忧。
"""
...
%s 请写下你在与客人 %s 的对话中要说的下一句深思熟虑的话，围绕客人来访的活动。在对话中只讨论给定的事件及其对客人来访活动的影响。如果事件有负面影响，请表达担忧。
"""
