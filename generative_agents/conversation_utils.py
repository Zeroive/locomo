...
%s 刚下班回到家，正在与家人 %s 交谈。今天是 %s，现在是下班后。请扮演 %s 的角色，写下你对家人 %s 要说的下一句话。如果开始对话，可以从打招呼、分享工作趣事、询问家人一天的情况、提醒重要事情或讨论晚餐安排开始。不要重复之前已分享的信息。让对话围绕下班回家后的活动，例如谈论工作经历、关心家人健康、提醒即将发生的事情、计划晚上活动或分享心情。包括时间参考，如"今天晚上"、"下班后"等。回复不超过20个字。
...
- 如果开始对话，可以从打招呼、分享工作趣事、询问家人一天情况、提醒重要事情或讨论晚餐安排开始。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天晚上"、"下班后"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
%s 刚下班回到家，正在与家人 %s 交谈。今天是 %s，现在是下班后。以下是 %s 最近发生的事件。
事件：%s

请扮演 %s 的角色，与家人 %s 就这些事件进行对话，围绕下班回家后的活动。%s
"""
...
今天是 %s，现在是下班后。请扮演 %s 的角色，写下你对家人 %s 要说的下一句话。如果开始对话，可以从打招呼、分享工作趣事、询问家人一天情况、提醒重要事情或讨论晚餐安排开始。不要重复已分享的信息。让对话围绕下班回家后的活动，例如谈论工作经历、关心家人健康、提醒即将发生的事情、计划晚上活动或分享心情。包括时间参考，如"今天晚上"、"下班后"等。回复不超过20个字。
...
- 如果开始对话，可以从打招呼、分享工作趣事、询问家人一天情况、提醒重要事情或讨论晚餐安排开始。
- 不要重复之前对话中已分享的信息。
- 让对话围绕下班回家后的活动，例如谈论工作经历、关心家人健康、提醒即将发生的事情、计划晚上活动或分享心情。
- 包括时间参考，如"今天晚上"、"下班后"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
今天是 %s，现在是下班后。你是 %s。以下是你最近发生的事件：
%s

在对话中使用这些事件。%s 请根据你的PERSONALITY写下你在与家人 %s 的对话中要说的下一句话：
"""
...
使用给定的PERSONALITY写下对话中你要说的下一句话。
- 回复不超过20个字。
- 让对话围绕下班回家后的活动，例如谈论工作经历、关心家人健康、提醒即将发生的事情、计划晚上活动或分享心情。详细讨论重要的事件。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天晚上"、"下班后"等。
...
%s 上次与家人 %s 交谈是在 %s。今天是 %s，现在是下班后。你是 %s。
...
%s 请写下你在与家人 %s 的对话中要说的下一句深思熟虑的话。在对话中只讨论给定的事件及其对你下班回家后活动的影响。如果事件有负面影响，请表达担忧。
"""
...
%s 请写下你在与家人 %s 的对话中要说的下一句深思熟虑的话，围绕下班回家后的活动。在对话中只讨论给定的事件及其对你下班回家后活动的影响。如果事件有负面影响，请表达担忧。
"""
