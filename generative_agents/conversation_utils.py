...
%s 刚放学回到家，正在与家人 %s 交谈。今天是 %s，现在是放学后。请扮演 %s 的角色，写下你对家人 %s 要说的下一句话。如果开始对话，可以从打招呼、分享学校趣事、讨论作业、想吃零食或谈论课外活动开始。不要重复之前已分享的信息。让对话围绕放学回家后的活动，例如谈论学校生活、作业安排、想吃的零食、课外活动或与家人分享心情。包括时间参考，如"今天下午"、"放学后"等。回复不超过20个字。
...
- 如果开始对话，可以从打招呼、分享学校趣事、讨论作业、想吃零食或谈论课外活动开始。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天下午"、"放学后"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
%s 刚放学回到家，正在与家人 %s 交谈。今天是 %s，现在是放学后。以下是 %s 最近发生的事件。
事件：%s

请扮演 %s 的角色，与家人 %s 就这些事件进行对话，围绕放学回家后的活动。%s
"""
...
今天是 %s，现在是放学后。请扮演 %s 的角色，写下你对家人 %s 要说的下一句话。如果开始对话，可以从打招呼、分享学校趣事、讨论作业、想吃零食或谈论课外活动开始。不要重复已分享的信息。让对话围绕放学回家后的活动，例如谈论学校生活、作业安排、想吃的零食、课外活动或与家人分享心情。包括时间参考，如"今天下午"、"放学后"等。回复不超过20个字。
...
- 如果开始对话，可以从打招呼、分享学校趣事、讨论作业、想吃零食或谈论课外活动开始。
- 不要重复之前对话中已分享的信息。
- 让对话围绕放学回家后的活动，例如谈论学校生活、作业安排、想吃的零食、课外活动或与家人分享心情。
- 包括时间参考，如"今天下午"、"放学后"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
使用给定的PERSONALITY写下对话中你要说的下一句话。
- 回复不超过20个字。
- 让对话围绕放学回家后的活动，例如谈论学校生活、作业安排、想吃的零食、课外活动或与家人分享心情。详细讨论重要的事件。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天下午"、"放学后"等。
...
%s 上次与家人 %s 交谈是在 %s。今天是 %s，现在是放学后。你是 %s。
...
%s 请写下你在与家人 %s 的对话中要说的下一句深思熟虑的话。在对话中只讨论给定的事件及其对你放学回家后活动的影响。如果事件有负面影响，请表达担忧。
"""
...
%s 请写下你在与家人 %s 的对话中要说的下一句深思熟虑的话，围绕放学回家后的活动。在对话中只讨论给定的事件及其对你放学回家后活动的影响。如果事件有负面影响，请表达担忧。
"""
