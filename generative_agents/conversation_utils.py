...
%s 在家中，准备独自外出前与AI助手 %s 交谈。今天是 %s，现在是出门前。请扮演 %s 的角色，写下你对AI助手 %s 要说的下一句话。如果开始对话，可以从讨论出门计划、检查随身物品、健康提醒或安全注意事项开始。不要重复之前已分享的信息。让对话围绕离家前的准备，例如谈论出行路线、天气情况、携带物品、健康状况或安全提醒。包括时间参考，如"今天上午"、"出门前"等。回复不超过20个字。
...
- 如果开始对话，请从讨论出门计划、检查随身物品、健康提醒或安全注意事项开始。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天上午"、"出门前"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
%s 在家中，准备独自外出前与AI助手 %s 交谈。今天是 %s，现在是出门前。以下是 %s 最近发生的事件。
事件：%s

请扮演 %s 的角色，与AI助手 %s 就这些事件进行对话，围绕离家前的准备。%s
"""
...
今天是 %s，现在是独自外出前。请扮演 %s 的角色，写下你对AI助手 %s 要说的下一句话。如果开始对话，请从讨论出门计划、检查随身物品、健康提醒或安全注意事项开始。不要重复已分享的信息。让对话围绕离家前的准备，例如谈论出行路线、天气情况、携带物品、健康状况或安全提醒。包括时间参考，如"今天上午"、"出门前"等。回复不超过20个字。
...
- 如果开始对话，请从讨论出门计划、检查随身物品、健康提醒或安全注意事项开始。
- 不要重复之前对话中已分享的信息。
- 让对话围绕离家前的准备，例如谈论出行路线、天气情况、携带物品、健康状况或安全提醒。
- 包括时间参考，如"今天上午"、"出门前"等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
今天是 %s，现在是独自外出前。你是 %s。以下是你最近发生的事件：
%s
...
使用给定的PERSONALITY写下对话中你要说的下一句话。
- 回复不超过20个字。
- 让对话围绕离家前的准备，例如讨论出行路线、天气情况、携带物品、健康状况或安全提醒。详细讨论重要的事件。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如"今天上午"、"出门前"等。
...
%s 上次与AI助手 %s 交谈是在 %s。今天是 %s，现在是独自外出前。你是 %s。
...
%s 请写下你在与AI助手 %s 的对话中要说的下一句深思熟虑的话。在对话中只讨论给定的事件及其对你离家前准备的影响。如果事件有负面影响，请表达担忧。
"""
...
%s 请写下你在与AI助手 %s 的对话中要说的下一句深思熟虑的话，围绕离家前的准备。在对话中只讨论给定的事件及其对你离家前准备的影响。如果事件有负面影响，请表达担忧。
"""
