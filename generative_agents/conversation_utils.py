...
PERSONA_FROM_MSC_PROMPT = """根据给定的生活属性编写说话人描述。示例：

%s

注意：在人物描述中添加关于该人的重要细节，例如姓名、年龄、婚姻状况、性别、工作等。适当时添加额外细节，如家人/朋友的名字或特定活动、喜好、经历。
...
%s 在家中，准备出门上班前与AI助手 %s 交谈。今天是 %s，现在是早上出门前。请扮演 %s 的角色，写下你对AI助手 %s 要说的下一句话。如果开始对话，可以从讨论今日工作安排、检查日程、提醒事项或家庭事务开始。不要重复之前已分享的信息。让对话围绕上班前的准备，例如谈论今日会议、待办事项、通勤安排或家庭琐事。包括时间参考，如"今天早上"、"上午会议"、"出门前"等。回复不超过20个字。
...
今天是 %s，现在是早上出门上班前。请扮演 %s 的角色，写下你对AI助手 %s 要说的下一句话。如果开始对话，请从讨论今日工作安排、检查日程、提醒事项或家庭事务开始。不要重复已分享的信息。让对话围绕上班前的准备，例如谈论今日会议、待办事项、通勤安排或家庭琐事。包括时间参考，如"今天早上"、"上午会议"、"出门前"等。回复不超过20个字。
