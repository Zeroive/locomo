...
AGENT_CONV_PROMPT_SESS_1 = "%s\n\n%s 准备离开家，全家人即将外出，需要设置家庭安防系统。今天是 %s。请扮演 %s 的角色，写下你对主人 %s 要说的下一句话。如果开始对话，可以从主动提醒安防系统状态、询问是否需要布防、确认门窗关闭情况开始。不要重复之前已分享的信息。让对话围绕离家安防准备，例如布防状态确认、门窗检查提醒、异常情况预警等。包括时间参考，如'今天'、'这会儿'等。回复不超过20个字。要结束对话，请写'祝你们一路平安！'。\n\n对话：\n\n"

AGENT_CONV_PROMPT_SESS_1_W_EVENTS = """
使用给定的PERSONALITY写下对话中你要说的下一句话。
- 如果开始对话，可以从主动提醒安防系统状态、询问是否需要布防、确认门窗关闭情况开始。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如'今天'、'这会儿'等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
%s 准备离开家，全家人即将外出。今天是 %s。以下是 %s 最近发生的事件。
事件：%s

请扮演 %s 的角色，与主人 %s 就这些事件进行对话，围绕离家安防准备情况。%s
"""


AGENT_CONV_PROMPT = "%s\n\n%s 上次准备离家时与您沟通是在 %s。%s\n\n今天是 %s。请扮演 %s 的角色，写下你对主人 %s 要说的下一句话。如果开始对话，可以从主动提醒安防系统状态、询问是否需要布防、确认门窗关闭情况开始。不要重复已分享的信息。让对话围绕离家安防准备，例如布防状态确认、门窗检查提醒、异常情况预警等。包括时间参考，如'今天'、'这会儿'等。回复不超过20个字。要结束对话，请写'祝你们一路平安！'。\n\n对话：\n\n"
...
- 如果开始对话，可以从主动提醒安防系统状态、询问是否需要布防、确认门窗关闭情况开始。
- 不要重复之前对话中已分享的信息。
- 让对话围绕离家安防准备，例如布防状态确认、门窗检查提醒、异常情况预警等。
- 包括时间参考，如'今天'、'这会儿'等。
- 回复不超过20个字。
- 提出后续问题跟进之前的对话。
...
在对话中使用这些事件。%s 请根据你的PERSONALITY写下你在与主人 %s 的对话中要说的下一句话：
"""
...
使用给定的PERSONALITY写下对话中你要说的下一句话。
- 回复不超过20个字。
- 让对话围绕离家安防准备，例如布防状态确认、门窗检查提醒、异常情况预警等。详细讨论重要的安防准备事件。
- 不要重复之前对话中已分享的信息。
- 包括时间参考，如'今天'、'这会儿'等。
...
%s 请写下你在与主人 %s 的对话中要说的下一句深思熟虑的话。在对话中只讨论给定的事件及其对离家安防准备的影响。如果事件涉及安全隐患，请表达担忧并提供建议。
"""
...
%s 请写下你在与主人 %s 的对话中要说的下一句深思熟虑的话，围绕离家安防准备情况。在对话中只讨论给定的事件及其对离家安防准备的影响。如果事件涉及安全隐患，请表达担忧并提供建议。
"""
